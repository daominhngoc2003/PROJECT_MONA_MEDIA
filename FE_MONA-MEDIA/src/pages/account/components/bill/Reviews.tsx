...
const Reviews = ({ open, setOpen, billId }: any) => {
    ...
    const fetPro = async () => {
        try {
            ...
            if (data) {
                // dispatch({ type: "bill/getAllBill", payload: data.bill })
                setBill(data.bill)
            }
        } catch (error: any) {
    ...
    const onHandleReview = async (value: any) => {
        ...
        bills?.products?.map(async (pro: any) => {
            ...
            try {
                ...
                const data: any = await postReviews(formData);
        ...
        <div>
            ...
            >
                ...
                <form onSubmit={handleSubmit(onHandleReview)}>
                    {bills?.products?.map((pro: any, index: string) => {
                        return (
